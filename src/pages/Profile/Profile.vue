<template>
   <section class="profile">
       ...
       <section class="profile_my_order">
           <a href="javascript:'';" class="my_order">
               <span>
                   <i class="iconfont icon-canyinfuwuqiye"></i>
               </span>
               <div class="my_order_div">
                   <span>服务中心</span>
                   <span class="my_order_icon">
...
.profile .profile-number .profile-link .profile_image .icon-geren1 {
    background: #e4e4e4;
    font-size: 62px;
}
...
.profile .profile-number .profile-link .user-info p .user-icon .icon-phone {
...
.profile .profile-number .profile-link .arrow .icon-z043 {
    color: #fff;
    font-size: 5px;
}
...
.profile .profile_my_order .my_order >span .icon-weibiaoti- {
    color: #02a774;
}
.profile .profile_my_order .my_order >span .icon-jifen {
    color: #ff5f3e;
}
.profile .profile_my_order .my_order >span .icon-canyinfuwuqiye {
    color: #02a774;
}
...
.profile .profile_my_order .my_order .my_order_div .my_order_icon .icon-z043 {
    color: #bbb;
    font-size: 10px;
}
</style>